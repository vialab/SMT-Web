...
<body>
	...
	<!--Start of this page's content-->
		<h2>
			Tutorial [ 1 | <a href="tutorial2.php">2</a> | <a href="tutorial3.php">3</a> ]
		</h2>
		<h4>Introduction</h4>
		<p>
...
zone.drag();
		...
		<p>
			The screenshot depicts the user dragging the zone ( the white rectangle ).
		</p>
		<img class="img-thumbnail" style="margin: 0 auto; display:block"
			src="img/tutorial1.png" alt="Tutorial 1 Screenshot">

		<h4>Next Tutorial</h4>
		<p>
			<a href="tutorial2.php">Tutorial 2 - TouchDown, TouchUp and Press</a>
		</p>

		<h4>Entire Source Code for Tutorial: 
			<a href="examples/Tutorial/One/One.pde">Download</a>
		</h4>
		<pre><code class="java"><?php
			include 'examples/Tutorial/One/One.pde';
		?></code></pre>
